...
internal sealed class HeadersConverter : JsonConverter<IEnumerable<KeyValuePair<string, IEnumerable<string>>>>
{
  ...
  internal HeadersConverter(bool keepSingleElementSequence = false)
  {
